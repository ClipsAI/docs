...
maintaining speaker-centric visual focus. For a detailed explanation, read [here](https://drive.google.com/file/d/13Oj38gIW8U6OfALtQR5AIDMQ9ZaLw_4O/view?usp=sharing). {{ className: 'lead' }}
