...
These libraries are leveraged to dynamically resize a video to focus on whoever is speaking at any given moment. For a detailed explanation of the algorithm, read [here](https://github.com/ClipsAI/clipsai/blob/main/report/report.pdf).{{ className: 'lead' }}
