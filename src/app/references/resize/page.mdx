...
These libraries are leveraged to dynamically resize a videos to focus on whoever is speaking at any given moment. For a detailed explanation of the algorithm, read [here](https://drive.google.com/file/d/1rWbPP8E9KUhxASY_LGuMBmZDvUrQpHCV/view?usp=drive_link).{{ className: 'lead' }}
