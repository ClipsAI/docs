...
```
[**Source Code**](https://github.com/ClipsAI/clipsai/tree/main/clipsai/transcribe)
...
<Properties>
    <Property name="model_size" type="string">
        One of the [model sizes](https://huggingface.co/openai/whisper-large#model-details) implemented by whisper/whisperx.
    </Property>
    <Property name="device" type="string: cpu | cuda">
        PyTorch device to perform computations on. Default is None (auto detects the correct device).
    </Property>
    <Property name="precision" type="string: float16 | int8">
